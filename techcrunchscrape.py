...
def getallLinks():
	...
	try:
		...
		for i in soup.find_all('div', {'class': 'river river--homepage'}):
			d = i.find('a')['href']
			links.append(d)
			print(d)
...
if __name__ == '__main__':
	getallLinks()
	excludes = ['You can also customize the types of stories it sends you.', 'TC Team', 'via,' 'You are about to activate', 'Facebook Messenger news bot' 'TC Messenger', 'Latest headlines delivered', 'Click on the button', 'photo:']
	scrape()
